 ...
 * @subpackage ione360_configurator/public
 */
 ...
 */
class ione360_configurator_Public
{
  /**
  ...
  public function enqueue_styles()
  {
    ...
    wp_enqueue_style(
      $this->plugin_name,
      plugin_dir_url(__FILE__) . "css/configurator-iOne360-public.css",
      [],
      $this->version,
      "all"
    );
  ...
  public function enqueue_scripts()
  {
    ...
    wp_enqueue_script(
      $this->plugin_name,
      plugin_dir_url(__FILE__) . "js/configurator-ione360-public.js",
      ["jquery"],
      $this->version,
      false
    );
